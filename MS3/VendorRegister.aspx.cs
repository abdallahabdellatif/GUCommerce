...
namespace Milestone3
{
    public partial class VendorRegister : System.Web.UI.Page
    {
        ...
        protected void Register_Click(object sender, EventArgs e)
        {
            ...
            string baccnum = bankAccount.Text;
            if (firstname == "")
            {
            ...
            {
                Response.Write("Company name cannot be empty");
            }
            else if (baccnum == "")
            {
                Response.Write("Bank account cannot be empty");
            }
            else
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@company_name", comname));
                cmd.Parameters.Add(new SqlParameter("@bank_acc_no", baccnum));
